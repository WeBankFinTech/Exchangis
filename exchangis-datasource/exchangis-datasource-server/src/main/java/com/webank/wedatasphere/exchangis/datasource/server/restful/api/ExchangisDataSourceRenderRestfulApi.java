 ...
 */
@RestController
@RequestMapping(value = "dss/exchangis/datasources/render", produces = {"application/json;charset=utf-8"})
public class ExchangisDataSourceRenderRestfulApi {
    ...
    public Message partition(@PathVariable("elementType") String type,
        ...
        result.setMethod("/api/rest_j/v1/dss/exchangis/datasources/render/partition/element/" + type);
        return result;
    }
