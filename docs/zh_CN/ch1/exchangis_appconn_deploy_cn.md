...
您在部署ExchangisAppConn之前，请按照[Exchangis1.0.1安装部署文档](https://github.com/WeBankFinTech/Exchangis/blob/dev-1.0.1-rc/docs/zh_CN/ch1/exchangis_deploy_cn.md)安装完成Exchangis1.0.1及其他相关组件的安装，并确保工程基本功能可用。
