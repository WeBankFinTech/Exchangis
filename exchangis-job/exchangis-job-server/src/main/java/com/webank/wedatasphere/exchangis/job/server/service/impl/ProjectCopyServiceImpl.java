...
public class ProjectCopyServiceImpl implements IProjectCopyService {
    ...
    @Autowired
    private DefaultJobInfoService defaultJobInfoService;
    ...
    public Message copy(Map<String, Object> params, String userName, HttpServletRequest request) throws ExchangisJobException, ExchangisJobServerException {
        ...
        ExportedProject exportedProject = defaultJobInfoService.export(projectId, moduleIdsMap, partial, request);
        ...
        IdCatalog idCatalog = projectImportServer.importOpt(projectJson, projectId, versionSuffix, userName);
