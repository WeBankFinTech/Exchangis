...
public class SqoopJobBuilder extends ExchangisJobBuilder {
    ...
    private String generateCode(ExchangisSubJob subjob, Long jobId) throws ExchangisDataSourceException {
        ...
        String code = "import --connect jdbc:mysql://127.0.0.1:3306/test --username root --password 123456 --table sqooptest --delete-target-dir --num-mappers 1 --hive-import --hive-database test --hive-table sqooptest --hive-overwrite --verbose";
        return code;
    }
