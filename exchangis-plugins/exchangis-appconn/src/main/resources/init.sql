...
INSERT INTO `dss_appconn_instance` (`appconn_id`, `label`, `url`, `enhance_json`, `homepage_uri`)
VALUES ((select id from `dss_appconn` where `appconn_name` = "exchangis" limit 1), 'PROD', 'http://APPCONN_INSTALL_IP:APPCONN_INSTALL_PORT/', '', '#/projectManage?labels=prod');
