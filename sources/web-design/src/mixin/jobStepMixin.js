    ...
    data() {
        const validateFieldDelimiter = (rule, value, callback) => {
            ...
            if (reg.test(value)) {
                ...
                checkUnicode.test(value) &&
                value.split("\\u")[1].length != 4
            ) {
        ...
        return {
            ...
            ruleValidate: {
                source: [{ required: true, message: this.$t("mixin.SJYBNK") }],
                path: [
                    { required: true, message: `path${this.$t("mixin.BBK")}` },
                    {
                        type: "string",
                        pattern: /^[^ ]+$/,
                        message: this.$t("mixin.LJBKBJKG"),
                        trigger: "blur",
                    },
                ],
                encoding: [
                ...
                transfer: [
                    {
                        required: true,
                        message: `transfer${this.$t("mixin.BBK")}`,
                    },
                ],
                fielType: [
                ...
                tableTow: [{ required: true, message: this.$t("mixin.BBNWK") }],
                indexName: [
                ...
                batchSize: [{ validator: validateBatchSize }],
            },
        };
    },
    methods: {
        ...
        getSourceDataList(value) {
            if (value != "") {
                ...
                this.FesApi.fetch(
                    ...
                    { sourceType: value, projectIds: this.treeId },
                    "get"
                )
                    .then((rst) => {
        ...
        sourceChange(value) {
            ...
            if (value == "") {
                ...
                this.FesApi.fetch(
                    "/datasource/meta/hive/" + value + "/dbs",
                    {},
                    {
                        method: "get",
                        timeout: "60000",
        ...
        tableValueChangeAction(value, dataparams) {
            // 选择表
                ...
                this.FesApi.fetch(
                    ...
                    .then((partitionInfo) => {
                        ...
                        if (
                            ...
                            this.editData.config[dataparams].partitions !==
                                "" &&
                            value === this.editData.config[dataparams].table
                        ) {
                            let val = this.editData.config[
                                dataparams
                            ].partitions.split(",")[0];
                            // custom value
                            if (
        ...
        partValueSelectAction(index, value, partitions, dataParams) {
            // 分区选择
            ...
            if (value !== "") {
                ...
                if (
                    ...
                    typeof partition !== "undefined" &&
                    index + 1 < this.partValCache.partKeys.length
                ) {
                    partition = {
                        name: this.partValCache.partKeys[index + 1],
                        value: "",
                        partitions: {},
                    };
                    this.timeTemplate(partition);
                ...
                if (
                    ...
                    let partValArray = this.editData.config[
                        dataParams
                    ].partitions.split(",");
                    ...
                    if (index + 1 < partValArray.length) {
                        ...
                        if (
                            nextValue.trim() !== "" &&
                            !partition.partitions[nextValue]
                        ) {
                    ...
                    if (valid) {
                        if (
                            ...
                            if (
                                ...
                                this.FesApi.fetch(
                                    `/datasource/meta/oracle/${dataSourceId}/${DBData}/${table}/check`,
                                    {},
                                    {
                                        method: "get",
                                        timeout: "60000",
