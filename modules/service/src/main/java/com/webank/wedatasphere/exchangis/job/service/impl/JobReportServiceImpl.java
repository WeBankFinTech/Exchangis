...
import com.webank.wedatasphere.exchangis.job.dao.JobReportDao;
 ...
 */
@Service
public class JobReportServiceImpl extends AbstractGenericService<JobReport> {
    @Autowired
    private JobReportDao jobReportDao;

    @Override
    protected IBaseDao<JobReport> getDao() {
        return jobReportDao;
    }
}
